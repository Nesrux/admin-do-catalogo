...
import com.nesrux.admin.catalogo.infrastructure.configuration.properties.google.GoogleCloudProperties;
...
public class GoogleCloudConfig {
    ...
    public Storage storage(
        ...
        final var retrySettings = RetrySettings.newBuilder()
                ...
                .setMaxRetryDelay(Duration.ofMillis(storageProperties.getRetryDelay()))
